...
export const SkillPill = memo(({ skill, orbitRadius, initialAngle, containerRef, resetKey, isPaused, isMobile }: any) => {
  ...
  return (
    ...
    >
      <div 
        className={`absolute -translate-x-1/2 -translate-y-1/2 rounded-full cursor-grab active:cursor-grabbing whitespace-nowrap flex flex-col items-center justify-center transition-all duration-500 ease-out backdrop-blur-2xl bg-white/70 dark:bg-[#000000]/70 border border-black/5 dark:border-white/10 shadow-[0_12px_40px_-12px_rgba(0,0,0,0.15),inset_0_1px_1px_rgba(255,255,255,0.8)] dark:shadow-[0_12px_40px_-12px_rgba(0,0,0,0.8),inset_0_1px_1px_rgba(255,255,255,0.15)] hover:!bg-primary/90 dark:hover:!bg-primary hover:!border-primary/50 dark:hover:!border-primary/80 hover:shadow-[0_16px_40px_-12px_var(--color-primary),inset_0_1px_1px_rgba(255,255,255,0.4)] active:!bg-primary/90 dark:active:!bg-primary active:!border-primary/50 dark:active:!border-primary/80 group ${sizeClasses[skill.size as keyof typeof sizeClasses]}`}
      >
        {/* Proficiency Badge */}
        {skill.proficiency && (
