export const translations = {
  ...
  ar: {
    ...
    projects: {
      ...
      featuredDesc: 'تطبيقاتي المتكاملة (Full-stack) الأكبر والأكثر تقدماً تقنياً، تتميز بهيكليات معقدة وتجربة مستخدم بجودة الإنتاج.',
      professionalTitle: 'مشاريع احترافية',
      professionalDesc: 'هيكلة واجهات أمامية بجودة الإنتاج ومهارات تطوير قابلة لإعادة الاستخدام.',
      practiceTitle: 'مشاريع تدريبية متقدمة',
      practiceDesc: 'استعراض لمفاهيم متقدمة للواجهات الأمامية، وتصميم معماري، ورسوم متحركة، وواجهات مستخدم حديثة.',
      learningTitle: 'مشاريع تعليمية',
      learningDesc: 'المشاريع التي ساعدت في بناء أساسياتي في الواجهات الأمامية ومهاراتي في JavaScript.',
    },
    skills: {
